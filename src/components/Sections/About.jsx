...
const aboutData = {
  cvpath      : "media/Felipe_Pauli_CV_v03.pdf",
  image       : "images/2.jpeg",
  name        : "Pauli, Felipe C.",
  location    : "Curitiba, PR, Brazil",
  birthday    : "16 December, 1983",
  email       : "fpauli@aincrivelfabrica.com",
  aboutMe     :
    "I'm Felipe de Pauli, an almost engineer (soon) from Curitiba, Brazil, that loves to be challenged. If you have challenges with you, don't be selfish, share it with me!!",
};
