...
const headerData = {
  ...
  imageThumb: "/images/dot.png",
  social: {
    facebook: "https://www.facebook.com/felipe.camargodepauli",
    twitter: "https://twitter.com/afabrica",
    instagram: "https://www.instagram.com/fcdpauli/",
    youtue: "https://www.youtube.com/c/FelipedePauliCaniba",
  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/">
          <img className="avatar" src={headerData.imageThumb} alt={headerData.name} />
        </Link>
